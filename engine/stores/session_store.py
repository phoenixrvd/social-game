...
class SessionStore:
    ...
    def load() -> Session:
        ...
        npc_id = str(data.get("npc", config.DEFAULT_NPC_ID)).strip() or config.DEFAULT_NPC_ID
        scene_id = str(data.get("scene", config.DEFAULT_SCENE_ID)).strip() or config.DEFAULT_SCENE_ID
