...
import type { NpcResponse, SceneResponse, StateResponse } from "../api/generated/model"
import { buildOptionsPath } from "../features/options/optionsRoutes"
import { currentImageUrl, npcImageUrl, npcVideoUrl, originalNpcImageUrl, sceneImageUrl } from "../api/mediaUrls"
import type { AppView, MessageView, NpcView, SceneView } from "./appViewTypes"
...
export function useAppView() {
  ...
  const isLoadingRelatedData = npcQuery.isLoading || sceneQuery.isLoading

  return {
    ...stateQuery,
    data: state ? mapAppView(state, npc, scene, npcOptions, sceneOptions) : undefined,
