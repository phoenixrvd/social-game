...
SCENE_PROMPT_PATH = config.PROJECT_ROOT / "prompts" / "scene_update.md"
...
class SceneUpdater(AbstractUpdater):
    ...
    def schedule(self) -> None:
        ...
        prompt = (
            load_text(SCENE_PROMPT_PATH).strip()
        ...
        raw_scene = run_prompt_small(prompt).strip()

        self.npc_store.save_scene(npc.npc_id, npc.scene.scene_id, raw_scene)
