...
# SG-018: Löschung und Default-Fallbacks

## Kontext
Das Projekt verwaltet Standardinhalte für NPCs und Scenes sowie lokale Ergänzungen.
SG-018 ergänzt `doc/requirements/sg-016-overrides-verzeichnis.md` um Regeln für optionale Löschung erstellter Inhalte und Default-Fallbacks.
Die fachlichen Anforderungen zum Anlegen neuer NPCs sind in `doc/requirements/sg-024-npc-erstellung-in-der-web-gui.md` gebündelt.
...
**Referenzen:** `doc/requirements/sg-009-git-basierte-spielstandshistorie.md`, `doc/requirements/sg-011-web-gui.md`, `doc/requirements/sg-024-npc-erstellung-in-der-web-gui.md`
