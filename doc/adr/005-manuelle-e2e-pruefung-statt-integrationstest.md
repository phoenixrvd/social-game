...
## Kontext
- Ein automatisierter End-to-End-Integrationstest für den Gesamtfluss `chat -> STM -> State/ETM Side-Effects` wäre grundsätzlich wünschenswert.
...
## Entscheidung
- Der Gesamtfluss `chat -> STM -> State/ETM Side-Effects` wird aktuell manuell als E2E-Prüfung validiert statt durch einen vollständigen automatisierten Integrationstest.
...
- Die manuelle Prüfung deckt den realen Ablauf einschließlich Persistenz in `.data/` und der sichtbaren Side-Effects der beteiligten Services ab.
